<?php
    ...
    $sql_post = "SELECT p.*, u.username, u.avatar, u.is_verified FROM group_posts p JOIN users u ON p.user_id = u.id WHERE p.id = ?";
    ...
    $sql_comments_all = "SELECT c.*, u.username, u.avatar, u.is_verified FROM group_comments c JOIN users u ON c.user_id = u.id WHERE c.post_id = ? ORDER BY c.created_at ASC";
        ...
        foreach ($comments_by_parent[$parent_id] as $comment) {
            ...
            echo '<div class="comment-container" id="comment-' . $comment['id'] . '">';
                ...
                if ($loggedIn) {
                    ...
                    echo '  <form action="gr_submit_comment.php" method="POST" enctype="multipart/form-data" class="comment-submission-form">';
    ...
    <div class="main-body">
        <main class="container">
            ...
            <div class="post">
                ...
                <?php
                    $stmt_media_post = $conn->prepare("SELECT file_path, media_type FROM post_group_media WHERE post_id = ?");
            ...
            <div class="comment-section" 
                ...
                <div class="comment-form">
                    <form action="gr_submit_comment.php" method="POST" enctype="multipart/form-data" class="comment-submission-form">
...
<script src="/galaxy/js/gr_post_details.js"></script>
</body>
</html>  