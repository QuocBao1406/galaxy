...
<head>
    ...
    <title>Trái Đất - Hành Tinh Xanh Của Sự Sống</title>
    ...
    <style>
        ...
        body {
            background-color: #050c1a; /* Nền xanh dương rất đậm, gần như đen */
            color: #cccccc;
        ...
        .nasa-iframe-container {
            ...
            padding: 25px;
            max-width: 1100px;
            background-color: rgba(10, 20, 40, 0.6); /* Nền xanh dương đậm pha chút trong suốt */
            border-radius: 15px;
            text-align: center;
            border: 1px solid #004080; /* Viền xanh navy sẫm */
        }
        ...
        .planet-content-section { 
            ...
            max-width: 1100px;
            margin: 40px auto;
            background: linear-gradient(145deg, rgba(15, 30, 60, 0.9), rgba(25, 45, 80, 0.95)); /* Gradient nền xanh dương/biển */
            border-radius: 15px;
            border: 1px solid #4682B4; /* Viền màu SteelBlue */
            box-shadow: 0 4px 25px rgba(70, 130, 180, 0.25); /* Bóng đổ màu SteelBlue */
        }

        .planet-content-section h2, .planet-content-section h3, .planet-content-section h4 {
            font-family: 'Exo 2', sans-serif;
            color: #6495ED; /* CornflowerBlue cho tiêu đề */
        ...
        .planet-content-section h3 {
            ...
            font-size: 2.4em;
            font-weight: 600;
            border-bottom: 2px solid #007BA7; /* Cerulean Blue cho gạch chân */
            padding-bottom: 10px;
        ...
        .planet-content-section .highlight-green { /* Màu xanh lá cho các tiêu đề liên quan đến sự sống/thiên nhiên */
            color: #90EE90; /* LightGreen */
            border-bottom-color: #2E8B57; /* SeaGreen */
        ...
        .planet-content-section strong {
            font-weight: 700;
            color: #F0F8FF; /* AliceBlue - màu sáng hơn cho chữ đậm */
        }
        ...
        .planet-image-container {
            text-align: center;
            margin: 30px 0;
            background-color: rgba(10,20,30,0.2); /* Nền xanh đen tối cho ảnh */
            padding: 20px;
            border-radius: 10px;
        }
        ...
        .planet-image-container img {
            ...
            height: auto;
            border-radius: 10px;
            border: 4px solid #4682B4; /* Viền SteelBlue */
            box-shadow: 0 0 20px rgba(70, 130, 180, 0.6);
        }
        
        .info-box {
            background-color: rgba(0, 50, 100, 0.5); /* Xanh dương đậm cho info box */
        ...
        .planet-gallery-section { 
            ...
            margin: 50px auto;
            padding: 30px;
            background: rgba(10, 25, 50, 0.7); /* Nền xanh dương sẫm cho gallery */
            border-radius: 15px;
            border: 1px solid #005A9C; /* Xanh biển đậm hơn */
            box-shadow: 0 4px 20px rgba(0, 90, 156, 0.2);
        }

        .planet-gallery-section h3 {
            font-family: 'Exo 2', sans-serif;
            color: #87CEEB; /* SkyBlue gallery title */
            text-align: center;
            font-size: 2.4em;
            margin-bottom: 30px;
        ...
        .image-grid .gallery-item {
            ...
            border: 2px solid #007BA7; /* Cerulean Blue */
        }
        ...
        .image-grid .caption {
            ...
            background-color: rgba(5, 20, 40, 0.8); /* Nền xanh dương tối cho caption */
    ...
    <img src="/galaxy/images-icon/logo3.png" alt="logonhom" class="logo-overlay">
     ...
     <main class="sun-content-section">
        <?php
            ...
            $content_file = $_SERVER['DOCUMENT_ROOT'] . "/galaxy/content/earth_{$current_lang}.html";
